package me.study.springboot.domain.jdbc.dao.impl;
...
import me.study.springboot.domain.jdbc.base.JdbcDaoImpl;
import me.study.springboot.domain.jdbc.base.Page;
import me.study.springboot.domain.jdbc.base.Sql;
import me.study.springboot.domain.jdbc.dao.IUserJdbcDao;

@Repository
public class UserJdbcDaoImpl extends JdbcDaoImpl implements IUserJdbcDao {

	//@Autowired
	//private JdbcTemplate jdbcTemplate;

	@Override
	public int insert(JdbcUser roncooUser) {
	...
	@Override
	public int updateById(JdbcUser roncooUser) {
	...
	@Override
	public JdbcUser selectById(int id) {
		...
		return queryForObject(sql, JdbcUser.class, id);
	}

	@Override
	public Page<JdbcUser> queryForPage(int pageCurrent, int pageSize, String name){
		// 确定参数
		...
		return queryForPage(sql.toString(), pageCurrent, pageSize, JdbcUser.class);
	}	
